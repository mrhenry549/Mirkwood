...
public class WQuest extends BasicWindow{
    Label _lMoves;
...
//	    AudioFilePlayer.getFilePlayer("jump.ogg").startPlaying();
		...
		try {
			sb = FileSystem.readFile(getClass(), "tomarreco.txt");
...
//			e.printStackTrace();
		...
		pstatevent.addComponent(new PanelStatus().withBorder(Borders.singleLineBevel("Tó Marreco")));
		pstatevent.addComponent(new Label("> Hello traveller! \nI have a quest for you."));
